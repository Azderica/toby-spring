...
* The following dependency is not known to work with Spring Native: 'Spring Configuration
...
* [Configure the Spring AOT Plugin](https://docs.spring.io/spring-native/docs/0.10.2/reference/htmlsingle/#spring-aot-gradle)
...
```
$ docker run --rm toby-spring:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/toby-spring
```
